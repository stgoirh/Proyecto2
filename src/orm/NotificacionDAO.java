...
public class NotificacionDAO {
	...
	public static boolean save(orm.Notificacion notificacion) throws PersistentException {
		try {
			orm.BDProyecto2PersistentManager.instance().saveObject(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Notificacion notificacion) throws PersistentException {
		try {
			orm.BDProyecto2PersistentManager.instance().deleteObject(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Notificacion notificacion)throws PersistentException {
		try {
			if (notificacion.getGruposu() != null) {
				notificacion.getGruposu().notificacion.remove(notificacion);
			}
			
			orm.Visto_Not[] lVisto_Nots = notificacion.visto_Not.toArray();
			for(int i = 0; i < lVisto_Nots.length; i++) {
				lVisto_Nots[i].setNotificacionu(null);
			}
	...
	public static boolean refresh(orm.Notificacion notificacion) throws PersistentException {
		try {
			orm.BDProyecto2PersistentManager.instance().getSession().refresh(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Notificacion notificacion) throws PersistentException {
		try {
			orm.BDProyecto2PersistentManager.instance().getSession().evict(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
