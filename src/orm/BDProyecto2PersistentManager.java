...
public class BDProyecto2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "BDProyecto2";
	...
	private BDProyecto2PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new BDProyecto2PersistentManager();
		}
