 ...
 * @author John Titor
 */
@WebServlet(name = "ServletCrearNotificacion", urlPatterns = {"/CrearNotificacion"})
public class ServletCrearNotificacion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String mensajeActividad = request.getParameter("mensaje");
