...
public class ServletEliminarContacto extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String resultado ="no se ha podido eliminar contacto";        
        try {
            resultado = "se ha eliminado el grupo de uid: "+String.valueOf(contactoNegocio.eliminarContactoCapaNegocio(contactoNegocio));
        } catch (Exception ex) {
