<%-- 
    Document   : vistoNotificacion
    Created on : 06-07-2016, 19:46:03
    Author     : Xiterss
--%>
...
<html>
    ...
    <body style="background-color: chocolate;">
        ...
        <div class="container">
            <div class="jumbotron">
                <form action="VistosNotificacion" method="post">
                    <div class="form-group">
                        <label for="nombreGrupo" class="col-sm-2 control-label" > Uid Notificacion </label>
                        <div class="col-sm-5">
                            <input type="text" placeholder="Uid Notificacion" class="form-control" id="nombreContacto"
                                   name="uidNotificacion" required>
                        </div>
                        <div class="col-sm-2">
